...
-- Renumbered from 20260717000002 (collided with add_company_metadata's
-- timestamp, which blocked `supabase start`'s migration apply on any fresh
-- Postgres). No content change; no dependency on migrations 000003/000004.
